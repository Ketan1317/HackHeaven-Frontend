...
const Room = () => {
  ...
  useEffect(() => {
    ...
    socketRef.current.on("user_left", (data) => {
      ...
      setMessages((prev) => [
        ...prev,
        { username: "System", message: `${data.username} left the room` },
      ]);
    ...
    <div className="flex h-screen bg-gradient-to-br from-gray-900 to-gray-800 text-white">
      ...
      <div className="w-2/3 flex flex-col">
        <div className="p-4 bg-gray-800/50 backdrop-blur-sm shadow-xl flex justify-between items-center border-b border-gray-700">
          <div className="flex items-center space-x-6 p-2 transition-all duration-300">
            {/* Room ID */}
            <span className="text-lg font-mono font-bold text-emerald-400 animate-fade-in tracking-wide">
              Room ID:{" "}
            ...
            <div className="flex items-center space-x-4">
              ...
              <select
                ...
                className="px-4 py-2 bg-gray-700 border border-emerald-400/50 rounded-lg text-white text-sm font-medium 
                   hover:bg-gray-600 hover:border-emerald-400 focus:outline-none focus:ring-2 focus:ring-emerald-400 
              ...
              >
                {LANGUAGES.map((lang) => (
                  <option
                    key={lang.value}
                    value={lang.value}
                    className="bg-gray-800 px-5 text-white"
                  >
                    {lang.label}
                  </option>
                ))}
          ...
          <div className="flex items-center space-x-4">
            <button
              ...
              className="px-4 py-2 bg-red-500 text-white rounded-xl hover:bg-red-600 font-bold transition-colors"
            >
              Leave Room
            </button>
            <button
              ...
              className="px-4 py-2 bg-emerald-500 text-white rounded-xl hover:bg-emerald-600 disabled:opacity-50 font-bold transition-colors"
            >
      ...
      {/* Right Panel - Chat */}
      <div className="w-1/3 flex flex-col border-l border-gray-700 relative">
        <div className="p-4 bg-gray-800/50 backdrop-blur-sm shadow-xl">
          <div className="mt-4">
            <h3 className="font-mono font-bold text-emerald-400 mb-2">
            ...
            <div className="bg-gray-900 rounded-lg p-2 max-h-24 overflow-y-auto">
              {participants.map((participant, index) => (
                <div
                  key={index}
                  className="py-1 px-2 rounded mb-1 bg-gray-800 flex items-center transition-all duration-300 hover:bg-gray-700"
                >
                  <span className="font-mono">{participant}</span>
                  {participant === username && (
                    <span className="ml-2 text-xs bg-emerald-500 px-2 py-0.5 rounded">
                      You
                    </span>
                  )}
                </div>
        ...
        <div
          className={`flex-1 p-4 overflow-auto h-[50vh] bg-gray-900/50 backdrop-blur-sm transition-all duration-500 ${
            chatbotOpen
        ...
        >
          ...
          {/* Chatbot Modal */}
          <div
            className={`absolute top-0 left-0 w-full h-full bg-gray-900/50 backdrop-blur-sm transition-all duration-500 transform ${
          ...
          >
            <div className="relative h-full">
              ...
              <button
                ...
                className="absolute top-4 right-4 text-white text-2xl font-bold hover:text-emerald-400 transition-colors duration-300"
              >
                ✖
              </button>
              <ChatBot
        ...
        <button
          onClick={toggleChatbot}
          className="absolute bottom-24 right-8 p-3 bg-emerald-500 text-white rounded-full shadow-lg hover:bg-emerald-600 transition-transform transform hover:scale-110"
        >
