        ...
        <div className="w-full max-w-md bg-white/5 backdrop-blur-lg border border-white/10 rounded-xl p-8 shadow-lg shadow-cyan-500/10 animate-fadeIn">
          ...
          <div className="mb-6">
            ...
            <select
              ...
              className="w-full px-5 py-3 rounded-2xl bg-gradient-to-br from-[#0F172A]/80 via-[#1E293B]/80 to-[#111827]/80 text-white border border-cyan-500/20 focus:outline-none focus:ring-4 focus:ring-cyan-500/50 transition-all duration-300 hover:shadow-xs hover:shadow-cyan-500/30 hover:scale-105 appearance-none"
            >
